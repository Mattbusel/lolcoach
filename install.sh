#!/bin/sh
# Install LoLCoach (review app) from the latest GitHub release.
#
#   curl -fsSL https://raw.githubusercontent.com/Mattbusel/lolcoach/main/install.sh | sh
#
...
# SHA256SUMS.txt, and copies one file (lolcoach) into INSTALL_DIR. Nothing else.
set -eu

REPO="Mattbusel/lolcoach"
PREFIX="lolcoach-review"      # archive name prefix
BIN="LoLCoach"            # file name inside the archive
CMD="lolcoach"            # command name you will type
