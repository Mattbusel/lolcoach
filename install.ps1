# Install LoLCoach (review app) on Windows from the latest GitHub release.
#
#   irm https://raw.githubusercontent.com/Mattbusel/lolcoach/main/install.ps1 | iex
#
# It downloads the Windows zip, checks it against the release's SHA256SUMS.txt,
# puts lolcoach.exe in %LOCALAPPDATA%\Programs\lolcoach and adds that folder to
...
Write-Host "Try it: lolcoach   (open a new terminal if the command is not found)"
